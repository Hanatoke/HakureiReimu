...
namespace HakureiReimu.HakureiReimuMod.Cards.Skill.Rare {
    public class BulletMoneyBonusPackets : AbstractCard
    {
        ...
        [
            new PowerVar<BulletMoneyBonusPacketsPower>(1)
        ];
        ...
        {
            await PowerCmd.Apply<BulletMoneyBonusPacketsPower>(cardPlay.Target,
                DynamicVars[BulletMoneyBonusPacketsPower.ID].BaseValue, Owner.Creature, this);
        }
